...
input_data_inst = input_data(
    "../data/Mannville_input_data/v0.0.3-alpha/OilSandsDB/PICKS.TXT",
    "\t",
    "../data/SPE_006_originalData/OilSandsDB/Logs/*.LAS",
)

input_data_inst.set_wells_file_path(
    "../data/Mannville_input_data/v0.0.3-alpha/OilSandsDB/WELLS.TXT", "\t"
)

input_data_inst.set_gis_file_path(
    "../data/Mannville_input_data/v0.0.3-alpha/well_lat_lng.csv", ","
)

input_data_inst.las_folder_path = (
    "../data/Mannville_input_data/v0.0.3-alpha/OilSandsDB/Logs/"
)
